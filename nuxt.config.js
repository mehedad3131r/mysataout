...
export default {
  ...
  head: {
    ...
    script: [
      {
        src: 'https://ajax.googleapis.com/ajax/libs/prototype/1.7.1/prototype.js',
      },
      {
  ...
  css: [
    ...
    '~/assets/app/assets/css/font.css',
    '~/assets/app/assets/css/main.css',
    '~/assets/app/mdb.min.css',
  ],
  ...
  plugins: [
    ...
    { src: '~/plugins/mdb.min.js', mode: 'client' },
  ],
